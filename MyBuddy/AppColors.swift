...
extension Color {
    ...
    static let chatBg       = Color(red: 0.925, green: 0.898, blue: 0.867)
    /// Superficies de formularios y listas (#F0F2F5)
    static let surface      = Color(red: 0.941, green: 0.949, blue: 0.961)
}
